...
import com.example.esdemo.bean.Tests;
...
@SpringBootTest(classes = { ESdemoApplication.class }) // 指定启动类
public class EsAppTest {
	...
	@Test
	public void testIndex01() throws IOException {
		// 判断是否存在索引
	...
	@Test
	public void testIndex02() throws IOException {
		// 判断是否存在索引
		if (!existsIndex(INDEX_TEST)) {
			// 不存在则创建索引
			createIndex(INDEX_TEST);
